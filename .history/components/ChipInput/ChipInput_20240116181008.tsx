...
const ChipInput: React.FC<ChipInputProps> = ({ availableSuggestions }) => {
  ...
  const handleDeleteChip = (chipToDelete: string) => {
    ...
    // Focus back to the input after deleting a chip
    ...
    <div className={styles.chipInput}>
      <div className={styles.chipContainer}>
        ...
        <input
          ...
          onFocus={() => setIsInputFocused(true)} // Set the focus state to true on focus
          onBlur={() => setIsInputFocused(false)} // Set the focus state to false on blur
          ref={inputRef} // Attach the ref to the input element
        />
      </div>
      {/* Render suggestions only if input is focused */}
