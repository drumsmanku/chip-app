    ...
    <div className={styles.chipInput}>
      <div className={styles.chipContainer}>
        ...
        <input
          ...
          onFocus={() => setInputFocused(true)} // set the focus state to true when the input is focused
          onBlur={() => {
            setInputFocused(false); // set the focus state to false when the input loses focus
            setHighlightedChipIndex(null);
          }}
        />
