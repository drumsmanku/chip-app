...
function SearchBar() {
  return (
    ...
    <StyledInputContainer item>
      <div className='flex bg-[#2C3A58] w-96 h-12 items-center pl-4 rounded-2xl '>
       <SearchIcon sx={{color:'#FFFFFF/90'}}/>
       <input className=' w-full h-full bg-[#2C3A58] rounded-2xl' type="text" placeholder='Search' />
      </div>
