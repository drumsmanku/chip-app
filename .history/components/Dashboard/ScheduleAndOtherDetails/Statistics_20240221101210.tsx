...
function Statistics() {
  return (
    <Grid container xs={9.5} style={styles}>
      <Grid container item direction='column' sx={{display:'flex', justifyContent:'space-around'}} xs={4}>
        <StyledGrid container item xs={4}>
        ...
        <StyledGrid1 container direction='column' item xs={5}>
          ...
          <Grid container xs={7} item sx={{ marginTop:'1rem'}}>
            <Grid item xs={5}>
